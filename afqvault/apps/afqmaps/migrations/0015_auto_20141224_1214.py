    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ttl_file', models.FileField(storage=None, upload_to=None, null=True, verbose_name=b'Turtle serialization of NIDM Results (.ttl)', blank=True)),
                ('provn_file', models.FileField(upload_to=None, storage=None, verbose_name=b'Provenance store serialization of NIDM Results (.provn)', blank=True)),
                ('zip_file', models.FileField(upload_to=None, storage=None, verbose_name=b'NIDM Results zip file')),

...
from afqvault.apps.afqmaps.models import User, Collection
from afqvault.apps.afqmaps.utils import get_similar_images
...
def down_data():
    import urllib, json
    if not os.path.isdir('/code/afqvault/apps/afqmaps/tests/bench'):
        os.makedirs('/code/afqvault/apps/afqmaps/tests/bench')
        os.makedirs('/code/afqvault/apps/afqmaps/tests/bench/images')
    if len(os.listdir('/code/afqvault/apps/afqmaps/tests/bench/images')) == 0:
        (path, _) = urllib.urlretrieve("https://ndownloader.figshare.com/files/5360999")
        archive = tarfile.open(path)
        archive.extractall('/code/afqvault/apps/afqmaps/tests/bench')
        archive.close()
        os.remove(path)
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        app_path = '/code/afqvault/apps/afqmaps/tests/bench'

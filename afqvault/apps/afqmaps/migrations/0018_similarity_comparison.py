...
def add_pearson_similarity(apps, schema_editor):
    Similarity = apps.get_model("afqmaps", "Similarity")
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image1', models.ForeignKey(related_name='image1', to='afqmaps.Image')),
                ('image2', models.ForeignKey(related_name='image2', to='afqmaps.Image')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(to='afqmaps.Similarity'),

...
import os.path
from afqvault.apps import statmaps
import zipfile
import subprocess
import tempfile
import shutil
    ...
    def handle(self, *args, **options):
        ...
        if args:
            ...
            for fixtureName in args:
                ...
                url = 'https://github.com/NeuroVault/afqvault_data/trunk/fixtures/%s' % fileName
            ...
            command = "wget https://raw.github.com/NeuroVault/afqvault_data/master/fixtures/dumpdata.zip -P %s " % temp1

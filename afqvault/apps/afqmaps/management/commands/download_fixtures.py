...
import os.path
from afqvault.apps import afqmaps
import zipfile
import subprocess
import tempfile
import shutil
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        afqmapsPath = os.path.abspath(afqmaps.__path__[0])
        fixturesDir = os.path.join(afqmapsPath, 'fixtures')
        ...
        if args:
            ...
            for fixtureName in args:
                ...
                url = 'https://github.com/afqvault/afqvault_data/trunk/fixtures/%s' % fileName
            ...
            command = "wget https://raw.github.com/afqvault/afqvault_data/master/fixtures/dumpdata.zip -P %s " % temp1

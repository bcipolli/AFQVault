    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(upload_to=afqvault.apps.afqmaps.models.upload_to, storage=afqvault.apps.afqmaps.storage.DoubleExtensionStorage(), verbose_name=b'File with the unthresholded map (.img, .nii, .nii.gz)')),
                ('add_date', models.DateTimeField(auto_now_add=True, verbose_name=b'date published')),
                ('modify_date', models.DateTimeField(auto_now=True, verbose_name=b'date modified')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_type', models.ForeignKey(related_name='afqmaps_valuetaggeditem_tagged_items', verbose_name='Content type', to='contenttypes.ContentType')),
                ('tag', models.ForeignKey(related_name=b'tagged_items', to='afqmaps.KeyValueTag')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='image',
            name='tags',
            field=taggit.managers.TaggableManager(to='afqmaps.KeyValueTag', through='afqmaps.ValueTaggedItem', blank=True, help_text='A comma-separated list of tags.', verbose_name='Tags'),

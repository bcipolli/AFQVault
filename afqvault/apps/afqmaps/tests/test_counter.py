...
class Test_Counter(TestCase):
    ...
    def test_adding_nidm(self):
        ...
        Image2ss = AFQMap(name='Image2 - single subject', collection=self.Collection3,
                          file='beta_0001.nii.gz', map_type="Other", analysis_level='S')
        Image2ss.file = SimpleUploadedFile('beta_0001.nii.gz', file(
            os.path.join(self.test_path, 'test_data/afqmaps/beta_0001.nii.gz')).read())
        Image2ss.save()

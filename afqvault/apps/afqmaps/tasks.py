...
def run_voxelwise_pearson_similarity(pk1):
    from afqvault.apps.afqmaps.models import Image
    from afqvault.apps.afqmaps.utils import get_images_to_compare_with
...
def save_voxelwise_pearson_similarity_reduced_representation(pk1, pk2):
    from afqvault.apps.afqmaps.models import Similarity, Comparison
    import numpy as np
...
def repopulate_cognitive_atlas(CognitiveAtlasTask=None,CognitiveAtlasContrast=None):
    if CognitiveAtlasTask==None:
        from afqvault.apps.afqmaps.models import CognitiveAtlasTask
    if CognitiveAtlasContrast==None:
        from afqvault.apps.afqmaps.models import CognitiveAtlasContrast

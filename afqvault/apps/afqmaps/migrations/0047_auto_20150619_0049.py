...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('afqmaps', '0046_auto_20150428_0616'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.ForeignKey(related_name='polymorphic_afqmaps.image_set+', editable=False, to='contenttypes.ContentType', null=True),
            preserve_default=True,
        ),
        migrations.AlterField(
            model_name='nidmresultstatisticmap',
